...
def getEntropy(obj, dims):
	entropy = 0 
	for index in dims:
		entropy += math.log(float(obj[index]) + 1 )
	return entropy

def sortInputFile(inputfile, outfile, dims, blocksize):
...
if __name__ == '__main__':
	...
	sortInputFile(inputfile, sortedfile, dims, blocksize)
	infilename = sortedfile
